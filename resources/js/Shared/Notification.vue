<template>
    <div v-if="$page.props.notification.success && show" class="flex items-center justify-between mb-8 max-w-3xl bg-green-500 rounded">
        <div class="flex items-center">
            ...
            <div class="py-4 text-white text-sm font-medium">{{ $page.props.notification.success }}</div>
        </div>
