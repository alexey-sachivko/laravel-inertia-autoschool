        ...
        <form @submit.prevent="update">
            <div class="flex flex-wrap -mr-6 p-8">
                ...
                <div class="pb-8 pr-6 w-full lg:w-1/2">
                    ...
                    <input id="username" type="text" v-model="form.username" class="p-2 leading-normal block w-full border text-gray-700 bg-white font-sans rounded text-left appearance-none relative focus:border-indigo-400 focus:ring" disabled />
            ...
            <div class="flex items-center justify-end px-8 py-4 bg-gray-50 border-t border-gray-100">
                <loading-button :loading="form.processing" class="btn-indigo" type="submit">Редактировать сотрудника</loading-button>
            </div>
        </form>
    </div>
</template>
    ...
    data() {
        return {
            form: this.$inertia.form({
                ...
                passport_info: this.user.passport_info,
